  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
	 ...
	 <br>
	  ...
	  <form class="form-signin" name="myform" action="validation.php" method="post" onSubmit="return validateform();">
        ...
        <button class="btn btn-large btn-primary" type="submit" value="submit" name="submit">Sign in</button>
      </form>
